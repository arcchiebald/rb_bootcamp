            ...
            {!fileInfo.name ? (
                ...
                >
                    <div className='pl-10 pr-10 flex items-center gap-2.5'>
                        <img src={fileInfo.preview} alt="Preview" className="w-13.5 h-13.5 shrink-0 object-cover rounded-[40px]" />
                        <div className="flex min-w-0 flex-col gap-1">
                            <p className="type-micro-helper-regular-s max-w-full truncate text-greyscale-600">
                                {fileInfo.name.split('.')[0]}.{fileInfo.name.split('.')[1].toUpperCase()}
                            </p>
