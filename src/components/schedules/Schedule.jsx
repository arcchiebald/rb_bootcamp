...
const Title = ({ stage = 1, title = "Course Introduction", disabled = true, defaultOpen = false, children }) => {
    ...
    // Style configurations based on disabled state
    ...
    return (
        <>
            <div className="flex flex-col gap-6 w-max">
                <Title stage={1} title="Weekly Schedule" disabled={false}>
                    <WeekDays days={["monday", "wednesday"]} />
                    <WeekDays days={["saturday", "sunday"]} />
                </Title>

                <Title stage={2} title="Time Slot" disabled={false}>
                    <TimeSlot variant="morning" />
                    <TimeSlot variant="afternoon" />
                    <TimeSlot variant="evening" />
                </Title>

                <Title stage={3} title="Session Type" disabled={false}>
                    <Session type="online" seatsLeft={3} />
                    <Session type="in_person" seatsLeft={0} />
                    <Session type="hybrid" seatsLeft={100} />
                </Title>
            </div>
            ...
            <div className="flex flex-col w-full h-fit bg-greyscale-50 border border-greyscale-100 rounded-xl p-10 gap-6">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-row justify-between items-center">
                        ...
                        <h2 className="type-heading-2 text-greyscale-800">$849</h2>
                    </div>

                    <div className="flex flex-col gap-3">
                        <div className="flex flex-row justify-between items-center">
                            <h4 className="type-body-s text-greyscale-400">Base Price</h4>
                            <h2 className="type-body-s text-greyscale-800">+ $84</h2>
                        </div>
                ...
                {/* Button */}
                <button className="w-full h-15.75 bg-purple-50 text-purple-200 rounded-xl p-2.5 gap-2.5 text-center hover:bg-purple-500 hover:text-greyscale-50 hover:cursor-pointer active:bg-purple-600 active:text-greyscale-50 transition-colors duration-300 flex items-center justify-center">
                    <h4 className="type-heading-4">Enroll Now</h4>
                </button>
            </div>
        </>
    )
