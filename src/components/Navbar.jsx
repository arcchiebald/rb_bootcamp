...
const Navbar = ({ user, onOpenRegistration, onOpenLogin, onOpenProfile, onOpenSidebar }) => {
  return (
    <nav className={`
        ...
        `}>
      <div className='flex w-391.5 mx-auto'>
      <a href="/" className='flex h-15 w-15 shrink-0 items-center justify-center rounded-[14px] bg-purple-500 px-4.25 py-4 cursor-pointer'>
      ...
      <div className='ml-auto flex items-center gap-9'>
        <div className='flex items-center gap-2 text-greyscale-600 fill-greyscale-600 hover:text-purple-500 hover:fill-purple-500 transition-colors duration-300 type-body-l cursor-pointer'>
        ...
        {!user ? (
          ...
          <div className='flex gap-9'>
            <div 
              ...
              className='flex items-center gap-2 text-greyscale-600 stroke-greyscale-600 hover:text-purple-500 hover:stroke-purple-500 transition-colors duration-300 type-body-l cursor-pointer'
            >
            ...
            <div onClick={onOpenProfile} className='relative flex h-14 w-14 cursor-pointer items-center justify-center overflow-visible rounded-full bg-purple-50 hover:ring-[1.5px] ring-purple-200 transition-shadow duration-300'>
              {user.avatar ? (
              ...
              <div className={`absolute -bottom-0.5 -right-0.5 h-4.25 w-4.25 rounded-full border-2 border-greyscale-50 transition-colors duration-300 ${user.profileComplete ? 'bg-helper-success' : 'bg-helper-warning'}`}></div>
            </div>
          </div>
        )}
